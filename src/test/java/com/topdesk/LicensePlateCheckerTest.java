...
- the letter sequence has at least the minNumLetter length specified
- the digit sequence has at least the minNumDigitA length specified
- the total length of all the parts of the license plate is exactly the total length specified*/
	...
	@Test
	void testLowerCaseLettersShouldFail() {
		checker.setSpecification(SPECIFICATION_1);
        assertFalse(checker.isValid(new LicensePlate("KL", "ab", "222")));
	}
